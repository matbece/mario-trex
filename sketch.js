...
function preload(){
  ...
  cloudImage = loadImage("pokebola.png");
  
  obstacle1 = loadImage("hongo.png");
  obstacle2 = loadImage("hongo.png");
  obstacle3 = loadImage("hongo.png");
  obstacle4 = loadImage("hongo.png");
  obstacle5 = loadImage("hongo.png");
  obstacle6 = loadImage("hongo.png");
